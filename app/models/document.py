...
class DocumentMetadata(BaseModel):
    ...
    custom_metadata: dict[str, Any] | None = Field(default=None, description="Custom metadata")
...
class DocumentSearchRequest(BaseModel):
    ...
    filter_tags: list[str] | None = Field(default=None, description="Filter by tags")
...
class DocumentChunk(BaseModel):
    ...
    relevance_score: float | None = Field(
        default=None, ge=0.0, le=1.0, description="Relevance score"
    )
