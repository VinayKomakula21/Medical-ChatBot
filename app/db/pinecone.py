...
def add_documents(
    texts: list[str], metadatas: list[dict[str, Any]] | None = None, ids: list[str] | None = None
) -> list[str]:
    try:
...
def search_similar_documents(
    ...
    try:
        ...
        # Search in Pinecone
        index = get_index()
        results = index.query(vector=query_embedding, top_k=k, filter=filter, include_metadata=True)
